...
//             We make finding and exploring internships simple, efficient, and transparent.
//           </p>
//         </div>
  ...
  const features = [
    {
      icon: <Zap size={32} color="#2563eb" />,
      title: "Personalized Recommendations",
      description: "Profile-based matching based on your skills, interests, and career goals"
    },
    {
      icon: <Shield size={32} color="#2563eb" />,
      title: "Explainable matches",
      description: "See matched skills, partial matches, and focused skill gaps for every result"
    },
    {
      icon: <Users size={32} color="#2563eb" />,
      title: "Profile-led discovery",
      description: "Build a structured profile and use it to rank relevant catalog opportunities"
    }
  ];
